<h2>How to use this visualisation:</h2>	
					...
					<p>Clicking on a letter on y-axis will select the words starting with that letter.</p>
					<p>Clicking on a letter on x-axis will select the words enidng in that letter.</p>
					<p>Clicking on a rectangle on the heatmap will select the words with the specified first and last letters.</p><br>

					<p>You can set the lower and upper limit for words' length using the sliders. The result will be reflected on the heatmap and the sankey diagram. </p><br>
